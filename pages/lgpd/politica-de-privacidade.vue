...
<script>
    ...
    export default {
        ...
        data() {
           let url = 'https://subseeon.com/lgpd/politica-de-privacidade/'
           if(process.client) {
                    ...
                    "@graph": [
                        {
                            ...
                            "@id": url,
                            "url": url,
                            "name": this.$t('head.policy.description'),
                            "description": this.$t('head.policy.description'),
                            "isPartOf": {
        ...
        head() {
            return {
                ...
                title:  this.$t('head.policy.title'),
                link:[
                    {
                        rel:    'canonical', 
                        href:   this.url
                ...
                meta:[
                    {
                        hid:      'description',
                        name:     'description',
                        content:  this.$t('head.policy.description')
                    },
                    {
                        hid:       'og:url',
                        property:  'og:url',
                    ...
                    },
                    {
                        hid:       'og:title',
                        property:  'og:title',
                        content:   this.$t('head.policy.title')
                    },
                    {
                        hid:       'og:description',
                    ...
                    },
                    {
                        hid:       'og:image',
                        property:  'og:image',
                        content:   "https://subseeon.com/images/sub100/sub100sistemas.png?date20231013"
                    },
                    {
                    hid:       'twitter:site',
                    name:      'twitter:site',

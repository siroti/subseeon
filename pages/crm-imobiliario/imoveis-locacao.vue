...
<script>
    ...
    export default {
        ...
        data() {
           let url = `https://subseeon.com/crm-imobiliario/imoveis-locacao/`;
           if(process.client) {
                url = window.location.href;
            }
            const name = "Imóveis Locação";
            const description =  "Qualifique os anúncios dos imóveis para locação com os valores adicionais ao aluguel com SUBSEE.";
            return {
                url: url,
                id: "locacao",
                name: name,
                description: description,
                Linkhref: "/#imoveis-locacao",
                structuredData: {
                    ...
                    "@graph": [
                        {
                            ...
                            "@id": url,
                            "url": url,
                            "name": this.$t('head.locacao.title'),
                            "description": this.$t('head.locacao.description'),
                            "isPartOf": {
                        ...
                        },
                        {
                            ...
                            "itemListElement": [
                                ...
                                {   "@type":"ListItem",
                                    ...
                                    "item":{
                                        "@id": url,
                                        "name": this.$t('head.locacao.listItem'),
                                    }
                                }
                            ]
                        },
        ...
        head() {
            return {
                ...
                title: this.$t('head.locacao.title'),
                link:[
                    {
                        rel:    'canonical', 
                        href:   this.url
                ...
                meta:[
                    {
                        hid:      'description',
                        name:     'description',
                        content:   this.$t('head.locacao.description')
                        },
                        {
                        hid:       'og:url',
                        property:  'og:url',
                        ...
                        hid:       'og:title',
                        property:  'og:title',
                        content:   this.$t('head.locacao.title'),
                        },
                        {
                        hid:       'og:description',

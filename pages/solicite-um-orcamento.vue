...
<script>
    ...
    export default {
        ...
        data() {
           let url = 'https://subseeon.com/solicite-um-orcamento/#site-hotsite';
           if(process.client) {
                    ...
                    "@graph": [
                        {
                            ...
                            "@id": url,
                            "url": url,
                            "name": this.$t('head.solicite.title'),
                            "description": this.$t('head.solicite.description'),
                            "isPartOf": {
                        ...
                        },
                        {
                            ...
                            "itemListElement": [
                                ...
                                {   "@type":"ListItem",
                                    ...
                                    "item":{
                                        "@id": url,
                                        "name":this.$t('head.solicite.listItem')
                                    }
                                }
                            ]
                        },
        ...
        head() {
            return {
                ...
                title:  this.$t('head.solicite.title'),
                link:[
                    {
                        rel:    'canonical', 
                        href:   this.url
                ...
                meta:[
                    {
                        hid:      'description',
                        name:     'description',
                        content:   this.$t('head.solicite.description')
                        },
                       {
                        hid:       'og:url',
                        property:  'og:url',
                        ...
                        hid:       'og:title',
                        property:  'og:title',
                        content:    this.$t('head.solicite.title')
                        },
                        {
                        hid:       'og:description',

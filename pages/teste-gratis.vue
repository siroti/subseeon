...
<script>
    ...
    export default {
        components: {
            ...
            FreeTrial: () => import('@/components/sub100/contents/FreeTrial'),
            Footer: () => import('@/components/sub100/Footer'),
        },
        data() {
           let url = 'https://subseeon.com/teste-gratis/';
           if(process.client) {
                    ...
                    "@graph": [
                        {
                            ...
                            "@id": url,
                            "url": url,
                            "name": this.$t('head.test.title'),
                            "description": this.$t('head.test.description'),
                            "isPartOf": {
                        ...
                        },
                        {
                            ...
                            "itemListElement": [
                                ...
                                {   "@type":"ListItem",
                                    ...
                                    "item":{
                                        "@id": url,
                                        "name":this.$t('head.test.listItem')
                                    }
                                }
                            ]
                        },
                ...
                meta:[
                    {
                        hid:      'description',
                        name:     'description',
                        content:   this.$t('head.test.description')
                        },
                       {
                        hid:       'og:url',
                        property:  'og:url',
                        ...
                        hid:       'og:title',
                        property:  'og:title',
                        content:    this.$t('head.test.title')
                        },
                        {
                        hid:       'og:description',
                        property:  'og:description',
                        content:    this.$t('hea.test.description')
                        },
                        {
                        hid:       'og:image',
                        property:  'og:image',
                        content:   "https://sistemasgl.com.br/images/sub100/sub100sistemas.png?date20231013"
                        },
                        {
                        hid:       'twitter:site',
                        name:      'twitter:site',

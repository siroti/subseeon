...
<style>
    .b-dropdown .dropdown-toggle::after { color: #333333!important }
    .fz-14 {font-size: 14px;}
    .dropdown-menu.show li{margin: 8px 0 5px;}
</style>
<style lang="scss" scoped>
    .fil0 {fill:#686AF1!important}
    .dark-mode {
        .fil0 {fill:#ffff!important}
        .btn-link {
            .text-dark { color: #ffff!important }
        }
    }
</style>
<script>

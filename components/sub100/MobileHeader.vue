...
<script>
    export default {
        components: {
            MobileNavigation: () => import('@/components/sub100/MobileNavigation'),
        },
        ...
        mounted() {
            this.$root.$on('to-slide', () => {
                this.mobiletoggleClass('removeClass', 'show-mobile-menu');
            })
        }
    };
</script>